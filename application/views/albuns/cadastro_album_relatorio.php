...
<div id="wrapper-body">
    ...
    <div class="row">
      	<form id="cadastro_album" action="<?= base_url() . 'index.php/relatorio/cadastrarAlbumRelatorio' ?>" method="post">
	        <div class="row">
	        ...
	        <div class="row">
	          	<div class="input-field col s12 m6 l4 offset-l2">
	          		<label>UPC/EAN</label>
	            	<input readonly pattern="[0-9]{12,13}" placeholder = "<?php echo $upc_ean;?>" value = "<?php echo $upc_ean;?>" title="12 ou 13 caracteres numericos" maxlength="13" required type="text" name="upc_ean"/>
	          	</div>
