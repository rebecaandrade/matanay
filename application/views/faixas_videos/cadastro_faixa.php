	...
	$(document).ready(function () {
		...
		$("#addArtista").click(function(e) {
			...
			newTextBoxDiv.after().html('<div class="row"><div class="input-field col s11 m9 l8 offset-l1">' +
				...
				'<div class="input-field col s12 m2 l2"><label><?php echo $this->lang->line("participacao");?></label><input name="percentual_artista[]" type="text"></div>' +
				'<a class="btn-floating btn-medium waves-effect waves-light btn tooltipped"' +
	...
	$(document).ready(function () {
		...
		$("#addAutor").click(function(e) {
			...
			newTextBoxDiv.after().html('<div class="row"><div class="input-field col s11 m9 l8 offset-l1">' +
				...
				'<div class="input-field col s12 m2 l2"><label><?php echo $this->lang->line("participacao");?></label><input name="percentual_autor[]" type="text"></div>' +
				'<a class="btn-floating btn-medium waves-effect waves-light btn tooltipped"' +
	...
	$(document).ready(function () {
		...
		$("#addProdutor").click(function(e) {
			...
			newTextBoxDiv.after().html('<div class="row"><div class="input-field col s11 m9 l8 offset-l1">' +
				...
				'<div class="input-field col s12 m2 l2"><label><?php echo $this->lang->line("participacao");?></label><input name="percentual_produtor[]" type="text"></div>' +
				'<a class="btn-floating btn-medium waves-effect waves-light btn tooltipped"' +
