...
<div id="wrapper-body">
    ...
    <div class="row">
      	<form id="cadastro_faixa" action="<?= base_url() . 'index.php/relatorio/cadastrar_faixa_relatorio' ?>" method="post">
	        <div class="row">
	        ...
	        <div class="row">
                <div id="isrcCadastre" class="input-field col s11 m8 l8 offset-l1">
                    <label>ISRC</label>
                    <input readonly value = "<?php echo $isrc; ?>" required pattern="[A-Z]{2}[A-Z0-9]{3}[0-9]{7}" id="isrcCadastreInput" class="isrcCadastreInput" type="text" name="isrc">
                </div>

                <div style="display: none" id="youtubeCadastre" class="input-field col s12 m9 l8 offset-l1">
                    <label>YouTube</label>
                    <input readonly value = "<?php echo $isrc; ?>" id="youtubeCadastreInput" class="youtubeCadastreInput" type="text" name="youtube">
                </div>
