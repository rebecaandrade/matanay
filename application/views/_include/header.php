        ...
        <ul id="nav-mobile" class="side-nav">
            ...
            <ul class="collapsible" data-collapsible="accordion">
                <li>
                    ...
                    <div class="collapsible-body">
                        <a href="<?php echo base_url().'index.php/cliente/cadastro_perfil/'.$this->session->userdata('id_cliente'); ?>"><?= $this->lang->line("perfis"); ?></a>
                    </div>
                </li>
            </ul>
...
<div id="barra2" class="grey darken-2" role="navigation">
    <div id="sub_menu" class="nav-wrapper container">
        <ul class="right hide-on-med-and-down">
            ...
            <li>
                <a href="<?php echo base_url().'index.php/cliente/cadastro_perfil/'.$this->session->userdata('id_cliente'); ?>"><?php echo $this->lang->line("perfis"); ?></a>
            </li>
        </ul>
    </div>
