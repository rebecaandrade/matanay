			...
			<tbody>
					<?php foreach($clientes as $cliente){ ?>
						<tr>
							...
							<td><a href="<?php echo base_url().'index.php/cliente/excluir_cliente/'.$cliente->idCliente;?>"><?php echo $this->lang->line('deletar'); ?></a>
								||<a href="<?php echo base_url().'index.php/cliente/lista_perfis/'.$cliente->idCliente;?>"><?php echo $this->lang->line('perfis'); ?></a>
								||<a href="<?php echo base_url().'index.php/cliente/atualiza_cliente/'.$cliente->idCliente;?>"><?php echo $this->lang->line('atualizar'); ?></a> </td>
						</tr> 
					<?php } ?>
			</tbody>
		<?php }else{ ?>
