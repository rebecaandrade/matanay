    ...
    <div class="row">
        ...
        <div class="row">
            <div class="input-field col s12 m6 l4 offset-l2">
                ...
                <input id="telefone" maxlength="15" value="<?php echo $telefone1->numero; ?>" name="telefone1" required
                       type="text"/>
            </div>
            <div class="input-field col s12 m6 l4">
                <label><?php echo $this->lang->line('telefone_alternativo'); ?>:</label>
                <input id="telefone1" maxlength="15" value="<?php echo $telefone2->numero; ?>" name="telefone2" required
                       type="text"/>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="input-field col s12 m6 l4 offset-l2">
                ...
                <input value="<?php echo $dadosentidade->percentual_fisico; ?>" name="percentual_fisico" required
                       type="text"/>
            </div>
            <div class="input-field col s12 m6 l4">
                <label><?php echo $this->lang->line('percentual_digital'); ?>:</label>
                <input value="<?php echo $dadosentidade->percentual_digital; ?>" name="percentual_digital" required
                       type="text"/>
            </div>
        </div>
        <div class="row">
                ...
                <select name="relacao_favorecido">
                    <?php foreach ($dadosfavorecido as $row) {
                        if ($dadosentidade->idFavorecido == $row->idFavorecido) { ?>
                            <option value="" disabled selected> <?php echo $this->lang->line('selecione'); ?>
                                (<?php echo $this->lang->line('atual'); ?>: <?php echo $row->nome; ?>)
                            </option>
                        <?php } ?>
