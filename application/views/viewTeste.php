                    ...
                    <div class="row">
                        <div class="col s12 m12 l8 offset-l2">
                            ...
                            <?php foreach ($funcionalidades as $func) { ?>
                                <p>
                                    <input type='checkbox' class="filled-in" id="<?php echo $func->idFuncionalidades ?>" name="func[]"
                                           value="<?php echo $func->idFuncionalidades ?>"/>
                                    <label
                                        for="<?php echo $func->idFuncionalidades ?>"> <?php echo $func->nome; ?></label>
                                </p>
                            <?php } ?>
                        </div>
                    </div>
